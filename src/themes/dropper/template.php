 ...
 * @see page.tpl.php
 */
function dropper_preprocess_page(&$variables) {
  global $base_path;
 ...
 */
function dropper_preprocess_maintenance_page(&$variables) {
  $css_path = backdrop_get_path('theme', 'dropper').'/css/component/maintenance.css';
 ...
 * @see layout.tpl.php
 */
function dropper_preprocess_layout(&$variables) {
 ...
 * @see node.tpl.php
 */
function dropper_preprocess_node(&$variables) {
 ...
 * @see header.tpl.php
 */
function dropper_preprocess_header(&$variables) {
  $logo            = $variables['logo'];
 ...
 */
function dropper_breadcrumb($variables) {
