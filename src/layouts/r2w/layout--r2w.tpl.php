...
<?php if ($content['r2w']): ?>
  <div id="r2w"  aria-label="<?php print t('R2W Region'); ?>">
    <div class="l-header-inner container container-fluid">

<div  id="r2w-label">
      <?php print "Theme: " . $GLOBALS['theme_key'];?>
</div>
      <?php print $content['r2w']; ?>
    </div>
  </div>
<?php endif; ?>
<hr>
